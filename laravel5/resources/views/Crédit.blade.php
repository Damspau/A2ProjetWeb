...
<main>
 <!--Définition d'un titre en gras souligné  -->
   <h1  class="titre"><u><strong>Crédit:</strong></u></h1>
<br>
 <!--Mise en place du texte a défilement automatique  -->
<marquee  class="crédit" direction="up" scrollamount="5"
  	 height="500"><font size="+2">Ce magnifique site web vous a était présenté par notre merveilleuse équipe technique qui est composés de: <br><br>
  	 ->Damien à la gestion des données de la base de données nationale...<br><br>
  	 ->Maxime au designe des pages Web ainsi qu'à la gestion de la boutique...<br><br>
  	 ->Charles au designe des pages Web ainsi qu'à la gestion de la base de données locale pour les événements...<br><br>
  	 Pour ce projet nous avons travaillé dans les locaux du CECI a l'adresse suivante: 8 Rue des Frères Charles et Alcide d' Orbigny, 64000 Pau</font>	</marquee>
